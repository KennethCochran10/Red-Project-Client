...
2. Description: This app will be able to create, read, update, and delete your 'trackers' as well as associated notes. Allowing you to keep track of your job inquiries in a more organized way. I'm hopeful that at some point I will code something that sends an email after a certain amount of time of not updating as a means to re-grab your attention to whats most important! Your trackers!
...
This app implements user authentication through validation of the JSON Web Token
...
Open [http://localhost:3025](http://localhost:3025) to view it in your browser.
